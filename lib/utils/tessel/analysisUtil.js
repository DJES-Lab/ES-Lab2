...
var analHorizontalVelocity = function(accelArray) {
    var horizontalVelocityArray = accelArray.map(function(obj, index) {
        if (index <= 0) {
            ...
            return{
                horizontalVelocityX: obj.x - accelArray[index-1].x,
                horizontalVelocityY: obj.y - accelArray[index-1].y,
                time: obj.time
            };
        }
...
var analHorizontalPosition = function(accelArray) {
    ...
    var horizontalPositionArray = horizontalVelocityArray.map(function(obj, index) {
        if (index <= 1) {
            ...
            return{
                horizontalPositionX: obj.horizontalVelocityX - horizontalVelocityArray[index-1].horizontalVelocityX,
                horizontalPositionY: obj.horizontalVelocityY - horizontalVelocityArray[index-1].horizontalVelocityY,
                time: obj.time
            };
        }
